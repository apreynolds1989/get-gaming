export const gameInfo = {
    ...
    concordia: {
        ...
        1. They allow a player to choose actions during the game.
        2. They are worth victory points (VPs) at the end of the game.
    ...
    oathChroniclesOfEmpireAndExile: {
    ...
    robinsonCrusoeAdventuresOnTheCursedIsland: {
    ...
    terraMystica: {
        ...
        1. Desert (Fakirs, Nomads)
        2. Plains (Halflings, Cultists)
        3. Swamp (Alchemists, Darklings)
        4. Lake (Mermaids, Swarmlings)
        5. Forest (Witches, Auren)
        6. Mountain (Dwarves, Engineers)
        7. Wasteland (Giants, Chaos Magicians)
    ...
    mysterium: {
        ...
        embedId: "https://www.youtube.com/watch?v=Bw2Xz9wp4KI",
...
export const smallGameInfo = {
    ...
    scrabble: {
        ...
        embedId: "https://www.youtube.com/watch?v=K1KgvZwwJqo",
